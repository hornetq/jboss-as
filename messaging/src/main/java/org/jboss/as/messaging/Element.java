...
public enum Element {
   ...
   BACKUP_PORT_OFFSET(HAPolicyDefinition.BACKUP_PORT_OFFSET),
   BACKUP_REQUEST_RETRIES(HAPolicyDefinition.BACKUP_REQUEST_RETRIES),
   BACKUP_REQUEST_RETRY_INTERVAL(HAPolicyDefinition.BACKUP_REQUEST_RETRY_INTERVAL),
   BACKUP_STRATEGY_TYPE(HAPolicyDefinition.BACKUP_STRATEGY_TYPE),
   ...
   MAX_BACKUPS(HAPolicyDefinition.MAX_BACKUPS),
   MAX_HOPS(ClusterConnectionDefinition.MAX_HOPS),
   MAX_REDELIVERY_DELAY(AddressSettingDefinition.MAX_REDELIVERY_DELAY),
   MAX_SAVED_REPLICATED_JOURNAL_SIZE(HAPolicyDefinition.MAX_SAVED_REPLICATED_JOURNAL_SIZE),
   ...
   REPLICATION_MASTER(CommonAttributes.REPLICATION_MASTER),
   REQUEST_BACKUP(HAPolicyDefinition.REQUEST_BACKUP),
   ...
   SCALE_DOWN_GROUP_NAME(HAPolicyDefinition.SCALE_DOWN_GROUP_NAME),
   ...
   public static Element forName(String localName) {
    ...
    private static Map<String, AttributeDefinition> getConnectorRefDefinitions() {
        ...
        result.put("ha-policy", HAPolicyDefinition.SCALEDOWN_CONNECTOR_REFS);
        result.put("ha-policy", HAPolicyDefinition.REMOTE_CONNECTOR_REFS);
        return result;
