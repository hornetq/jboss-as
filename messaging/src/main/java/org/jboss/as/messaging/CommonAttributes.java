...
public interface CommonAttributes {
    ...
    String ALLOW_FAILBACK2 = "allow-failback";
    String BACKUP_GROUP_NAME2 = "backup-group-name";
    String BACKUP_PORT_OFFSET = "backup-port-offset";
    String BACKUP_REQUEST_RETRIES = "backup-request-retries";
    String BACKUP_REQUEST_RETRY_INTERVAL = "backup-request-retry-interval";
    ...
    String MAX_SAVED_REPLICATED_JOURNAL_SIZE2 = "max-saved-replicated-journal-size";
    ...
    String REPLICATION_CLUSTERNAME2 = "replication-clustername";
    String REQUEST_BACKUP = "request-backup";
    String RESTART_BACKUP = "restart-backup";
    String QUEUE = "queue";
