...
public interface CommonAttributes {
    ...
    // FIXME set its deprecated to VERSION_1_1_0 once it is refactored to use a SimpleAttributeDefinition
    ...
    AttributeDefinition NODE_GROUP_NAME = create("node-group-name", ModelType.STRING)
            .setAllowNull(true)
            .setRestartAllServices()
            .build();
    ...
    AttributeDefinition[] SIMPLE_ROOT_RESOURCE_ATTRIBUTES = { PERSISTENCE_ENABLED, SCHEDULED_THREAD_POOL_MAX_SIZE,
            ...
            CREATE_BINDINGS_DIR, CREATE_JOURNAL_DIR, JOURNAL_TYPE, JOURNAL_BUFFER_TIMEOUT,
            ...
            PAGE_MAX_CONCURRENT_IO, CHECK_FOR_LIVE_SERVER, NODE_GROUP_NAME, REPLICATION_CLUSTERNAME };
